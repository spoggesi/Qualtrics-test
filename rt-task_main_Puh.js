...
var instructions = {
    ...
    stimulus: "<p>Please eat a spoonful of the sample, but do not finish it.</p>" +
                "<p>You will now carry out the same task.</p>" +
...
var test_stimuli = [{
        ...
        data: {test_part: 'energeticpuh', correct_response: 'j'}
    },
    {
        stimulus: '<div style="font-size:60px;">indulgent</div>',
        data: {test_part: 'indulgentpuh', correct_response: 'j'}
    },
    {
        stimulus: '<div style="font-size:60px;">nervous</div>',
        data: {test_part: 'nervouspuh', correct_response: 'j'}
    },
    {
        stimulus: '<div style="font-size:60px;">relaxed</div>',
        data: {test_part: 'relaxedpuh', correct_response: 'j'}
    },
    {
        stimulus: '<div style="font-size:60px;">active</div>',
        data: {test_part: 'activepuh', correct_response: 'j'}
    },
    {
        stimulus: '<div style="font-size:60px;">happy</div>',
        data: {test_part: 'happypuh', correct_response: 'j'}
    },
    {
        stimulus: '<div style="font-size:60px;">uninspired</div>',
        data: {test_part: 'uninspiredpuh', correct_response: 'j'}
    },
    {
        stimulus: '<div style="font-size:60px;">classic</div>',
        data: {test_part: 'classicpuh', correct_response: 'j'}
    },
    {
        stimulus: '<div style="font-size:60px;">impressed</div>',
        data: {test_part: 'impressedpuh', correct_response: 'j'}
    },
    {
        stimulus: '<div style="font-size:60px;">sour</div>',
        data: {test_part: 'sourpuh', correct_response: 'j'}
    },
    {
        stimulus: '<div style="font-size:60px;">sweet</div>',
        data: {test_part: 'sweetpuh', correct_response: 'j'}
    },
    {
        stimulus: '<div style="font-size:60px;">thick</div>',
        data: {test_part: 'thickpuh', correct_response: 'j'}
    },
    {
        stimulus: '<div style="font-size:60px;">creamy</div>',
        data: {test_part: 'creamypuh', correct_response: 'j'}
    },
    {
        stimulus: '<div style="font-size:60px;">healthy</div>',
        data: {test_part: 'healthypuh', correct_response: 'j'}
    },
    {
        stimulus: '<div style="font-size:60px;">tasty</div>',
        data: {test_part: 'tastypuh', correct_response: 'j'}
    }
];
